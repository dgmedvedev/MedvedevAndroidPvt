...
class Dz13Fragment : Fragment(), Dz9Adapter.ClickListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this.activity!!).get(Dz13ViewModel::class.java)
    ...
    private fun filledAdapter(listPoi: List<Poi>) {
        ...
        adapter = Dz9Adapter(listPoi, this@Dz13Fragment)
